...
<table id="example-category" class="display" cellspacing="0" border="1" style="width:100%; margin:0 auto; text-align:center;border-collapse: collapse;" >
			...
			$sql = "Select * from `tbl_User_Visited` WHERE `Session_ID` ='$rsessionid' AND page = 'Category' AND CONVERT_TZ(tbl_User_Visited.Spend_time, '+00:00','-8:00') BETWEEN '$startdate' and '$enddate'";
