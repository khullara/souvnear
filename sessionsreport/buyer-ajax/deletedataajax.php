...
$a=1;
$sql = "Select * from `tbl_cart_deleted` WHERE username='$id' AND  CONVERT_TZ(tbl_cart_deleted.DeletedOn, '+00:00','-8:00') BETWEEN '$startdate' and '$enddate'";
...
<table id="example-delete" class="display" cellspacing="0" border="1" style="width:100%; margin:0 auto; text-align:center;border-collapse: collapse;" >
			<thead>
				<tr>
					<th>Sr. No</th>
					<th>Buyer Name</th>
