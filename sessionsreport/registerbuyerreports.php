...
?>
	<!--form action="registerbuyerexcel.php" method="post">
...
$emailids = substr_replace($emailid ,"",-2);
	...
	$qrydel = "Select Count('username') as deletecount from `tbl_cart_deleted` WHERE username='$userid' AND  CONVERT_TZ(tbl_cart_deleted.DeletedOn, '+00:00','$timezone') BETWEEN '$startdate' and '$enddate'";
